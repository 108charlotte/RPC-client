...
def send_read_to_ip(address, propagate:bool=True): 
    ...
    try: 
        ...
        for i, item in enumerate(database): 
            ...
            if item['key'] == key: 
                ...
                database[i]['write_quorum_loading'] = False
                updated = True
...
def write(json_string): 
    ...
    if propagate: 
        ...
        for i, item in enumerate(database): 
            if item['key'] == key: 
                if not database[i]['write_quorum_loading']: 
                    database[i]['write_quorum_loading'] = True
